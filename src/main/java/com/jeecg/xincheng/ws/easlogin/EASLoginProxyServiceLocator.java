...
public class EASLoginProxyServiceLocator extends org.apache.axis.client.Service implements com.jeecg.xincheng.ws.easlogin.EASLoginProxyService {
    ...
    private java.lang.String EASLogin_address = "http://10.0.8.171:6888/ormrpc/services/EASLogin";
    ...
    public com.jeecg.xincheng.ws.easlogin.EASLoginProxy getEASLogin(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.jeecg.xincheng.ws.easlogin.EASLoginSoapBindingStub _stub = new com.jeecg.xincheng.ws.easlogin.EASLoginSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.jeecg.xincheng.ws.easlogin.EASLoginProxy.class.isAssignableFrom(serviceEndpointInterface)) {
                com.jeecg.xincheng.ws.easlogin.EASLoginSoapBindingStub _stub = new com.jeecg.xincheng.ws.easlogin.EASLoginSoapBindingStub(new java.net.URL(EASLogin_address), this);
                _stub.setPortName(getEASLoginWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://10.0.8.171:6888/ormrpc/services/EASLogin", "EASLoginProxyService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://10.0.8.171:6888/ormrpc/services/EASLogin", "EASLogin"));
        }
